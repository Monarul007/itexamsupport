<form class="card-body bg-white">
    <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="position-relative row form-group">
                        <div class="col-12">
                            @if ($prevAttachment)
                                Attachement Preview:
                                <img width="80px" style="border-radius: 100%;" src="{{ asset('storage/'.$prevAttachment.'')}}">
                            @endif
        ...
        <div class="col-12 mt-3">
            <button wire:click.prevent="update()" class="btn btn-secondary mb-2 mr-2">Update</button>
            <button wire:click.prevent="cancel()" class="btn btn-danger mb-2 mr-2">Cancel</button>
        </div>
    </div>
</form>